...
export interface ClientOptions {
  /**
   * Defaults to process.env['NPM_TOKEN_TEST_USERNAME'].
   */
  username?: string | null | undefined;

  /**
   * Defaults to process.env['NPM_TOKEN_TEST_PASSWORD'].
   */
  password?: string | null | undefined;

  /**
   * Defaults to process.env['NPM_TOKEN_TEST_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['NPM_TOKEN_TEST_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['NPM_TOKEN_TEST_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Npm Token Test API.
 */
export class NpmTokenTest {
   ...
   * API Client for interfacing with the Npm Token Test API.
   *
   * @param {string | null | undefined} [opts.username=process.env['NPM_TOKEN_TEST_USERNAME'] ?? null]
   * @param {string | null | undefined} [opts.password=process.env['NPM_TOKEN_TEST_PASSWORD'] ?? null]
   * @param {string | null | undefined} [opts.apiKey=process.env['NPM_TOKEN_TEST_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['NPM_TOKEN_TEST_BASE_URL'] ?? https://todo-ninja-ziix.onrender.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('NPM_TOKEN_TEST_BASE_URL'),
    username = readEnv('NPM_TOKEN_TEST_USERNAME') ?? null,
    password = readEnv('NPM_TOKEN_TEST_PASSWORD') ?? null,
    apiKey = readEnv('NPM_TOKEN_TEST_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? NpmTokenTest.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('NPM_TOKEN_TEST_LOG'), "process.env['NPM_TOKEN_TEST_LOG']", this) ??
      defaultLogLevel;
  ...
  protected stringifyQuery(query: Record<string, unknown>): string {
    return Object.entries(query)
      ...
      .map(([key, value]) => {
        ...
        throw new Errors.NpmTokenTestError(
  ...
  static NpmTokenTest = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static NpmTokenTestError = Errors.NpmTokenTestError;
